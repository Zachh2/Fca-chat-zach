...
if (!fs.existsSync(process.cwd() + '/ChatBot_Database')) {
    fs.mkdirSync(process.cwd() + '/ChatBoth_Database');
    fs.writeFileSync(process.cwd() + '/ChatBot_Database/A_README.md', 'This folder is used by Zach to store data. Do not delete this folder or any of the files in it.', 'utf8');
}
var Database = new sqlite3.Database(process.cwd() + "/ChatBot_Database/SyntheticDatabase.sqlite");
